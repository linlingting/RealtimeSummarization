...
\author{Lingting Lin\inst{1} \and Chen Lin\inst{1} \and Yongxuan Lai\inst{2}}
\authorrunning{L.Lin et al.}
\institute{Department of Computer Science, Xiamen University, China \email{linlingting@stu.xmu.edu.cn} \email{chenlin@xmu.edu.cn}\and School of Software, Xiamen University,China}
...
\keywords{Realtime summarization \and Inconsistency detection \and Simplex}
\end{abstract}
...
%inconsistency detection,Inconsistency is revealed via word order and syntactic structures. We need to assess information similarity based on the combination of semantic, lexical and syntactic analysis
...
% and execution times of our method have a narrower distribution, which implies that our method is more stable with events of different sizes.
